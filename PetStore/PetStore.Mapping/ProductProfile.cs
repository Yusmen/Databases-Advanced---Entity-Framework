...
namespace PetStore.Mapping
{
    public class ProductProfile : Profile
    {
        ...
        {
            this.CreateMap<AddProductInputServiceModel, Product>().ForMember(x => x.ProductType,
            ...
            this.CreateMap<CreateProductInputModel,
                AddProductInputServiceModel>();
            ...
            this.CreateMap<ListAllProductByNameServiceModel,
