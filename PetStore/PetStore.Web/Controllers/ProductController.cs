...
namespace PetStore.Web.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult All()
        {
            ...
            ICollection<ListAllProductsViewModel> viewModels = this.mapper
                .Map<List<ListAllProductsViewModel>>(allProducts);
        ...
        public IActionResult Create(CreateProductInputModel model)
        {
            ...
            AddProductInputServiceModel serviceModel = this.mapper
                .Map<AddProductInputServiceModel>(model);
        ...
        {
            ProductDetailsServiceModel serviceModel = this.productService
                .GetById(id);
        ...
        public IActionResult Search(string searchWord)
        {
            ...
            ICollection<ListAllProductByNameServiceModel> serviceModels = this.productService
                .SearchByName(searchWord, false);

            ICollection<ListAllProductsViewModel> viewModels = this.mapper
                .Map<List<ListAllProductsViewModel>>(serviceModels);
